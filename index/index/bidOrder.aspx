<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bidOrder.aspx.cs" Inherits="index.bidOrder" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server"  AutoGenerateColumns="False" BorderColor="White" ShowHeader="False" GridLines="None">
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
                        <div class="card">
...
<div class="p-4">
  ...
  <div class="text-center p-md-4">
    ...
    <hr>
    <h6 class="mb-3 background-color:gray"><%#Eval("ProductPrice") %>SAR</h6>
  </div>
</div>               
            </div>
        ...
        <div class="col-md-4 summary">
            ...
            <form>
               ...
               <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="TextBox1" ForeColor="Red" runat="server" ErrorMessage="Ship address"></asp:RequiredFieldValidator>                
                <p>SHIPPING</p> <select>
            ...
            <div class="row" style="border-top: 1px solid rgba(0,0,0,.1); padding: 2vh 0;">
                ...
                <div class="col text-right"><%#Eval("ProductPrice") %>SAR</div>
     ...
     <div class="col-md-4 summary">
        ...
        <asp:Label ID="Label2" runat="server" Visible="false" Text="Pending"></asp:Label>
