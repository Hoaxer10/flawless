<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendMessage.aspx.cs" Inherits="index.SendMessage" %>
        ...
        <div class="card-body row">
          ...
          <div class="col-7">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
              <label for="inputEmail">Receiver</label>
                <asp:TextBox ID="TextBox5" class="form-control" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="TextBox5" runat="server" ForeColor="Red" ErrorMessage="Please enter receiver's email"></asp:RequiredFieldValidator>
            </div>
            <div class="form-group">
